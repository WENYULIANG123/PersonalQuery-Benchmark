#!/usr/bin/env python3
"""ACL/CCOMP/AttrDensity 句法分析（spaCy模型分析）- 全合并版本
...
用法:
    python 05_syntactic_analysis_full.py [category]
...
# ============ 路径配置 ============
CATEGORY = sys.argv[1] if len(sys.argv) > 1 else "Arts_Crafts_and_Sewing"
