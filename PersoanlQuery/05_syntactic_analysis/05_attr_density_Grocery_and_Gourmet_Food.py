...
OUTPUT_JSONL = '/fs04/ar57/wenyu/result/personal_query/05_syntactic_analysis/Grocery_and_Gourmet_Food/attr_density_sentences.jsonl'
os.makedirs(os.path.dirname(OUTPUT_JSONL), exist_ok=True)
STATS_JSON = '/fs04/ar57/wenyu/result/personal_query/05_syntactic_analysis/Grocery_and_Gourmet_Food/attr_density_stats.json'
USERS_JSON = '/fs04/ar57/wenyu/result/personal_query/05_syntactic_analysis/Grocery_and_Gourmet_Food/attr_density_user_profiles.json'
...
def main():
    ...
    # 从单个JSON文件加载所有用户
    ALL_USERS_FILE = '/fs04/ar57/wenyu/result/personal_query/01_preference_extraction/Grocery_and_Gourmet_Food/stage1_filtered_users_reviews.json'
    ...
    # 加载Stage 1商品属性
    STAGE1_ATTR_FILE = '/fs04/ar57/wenyu/result/personal_query/01_preference_extraction/Grocery_and_Gourmet_Food/attributes_Grocery_and_Gourmet_Food.json'
