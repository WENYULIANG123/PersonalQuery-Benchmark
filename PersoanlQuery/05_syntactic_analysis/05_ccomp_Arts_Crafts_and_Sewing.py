...
OUTPUT_JSONL = '/fs04/ar57/wenyu/result/personal_query/05_syntactic_analysis/Arts_Crafts_and_Sewing/ccomp_sentences.jsonl'
STATS_JSON = '/fs04/ar57/wenyu/result/personal_query/05_syntactic_analysis/Arts_Crafts_and_Sewing/ccomp_stats.json'
USERS_JSON = '/fs04/ar57/wenyu/result/personal_query/05_syntactic_analysis/Arts_Crafts_and_Sewing/ccomp_user_profiles.json'
...
def main():
    ...
    # 从单个JSON文件加载所有用户
    ALL_USERS_FILE = '/fs04/ar57/wenyu/result/personal_query/01_preference_extraction/Arts_Crafts_and_Sewing/stage1_filtered_users_reviews.json'
    ...
    # 加载Stage 1商品属性
    STAGE1_ATTR_FILE = '/fs04/ar57/wenyu/result/personal_query/01_preference_extraction/Arts_Crafts_and_Sewing/attributes_Arts_Crafts_and_Sewing.json'
