...
OUTPUT_JSONL = '/fs04/ar57/wenyu/result/personal_query/05_syntactic_analysis/Arts_Crafts_and_Sewing/attr_density_sentences.jsonl'
os.makedirs(os.path.dirname(OUTPUT_JSONL), exist_ok=True)
STATS_JSON = '/fs04/ar57/wenyu/result/personal_query/05_syntactic_analysis/Arts_Crafts_and_Sewing/attr_density_stats.json'
USERS_JSON = '/fs04/ar57/wenyu/result/personal_query/05_syntactic_analysis/Arts_Crafts_and_Sewing/attr_density_user_profiles.json'
