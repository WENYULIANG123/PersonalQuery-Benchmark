...
def main() -> None:
    # ============ 硬编码参数 ============
    REVIEW_FILE = "/fs04/ar57/wenyu/data/Amazon-Reviews-2023/raw/review_categories/Pet_Supplies.jsonl"
    META_FILE = "/fs04/ar57/wenyu/data/Amazon-Reviews-2023/raw/meta_categories/meta_Pet_Supplies.jsonl.gz"
    OUTPUT_DIR = "/fs04/ar57/wenyu/result/personal_query/00_data_preparation/Pet_Supplies"
