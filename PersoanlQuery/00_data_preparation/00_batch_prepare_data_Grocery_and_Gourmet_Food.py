...
def main() -> None:
    # ============ 硬编码参数 ============
    REVIEW_FILE = "/fs04/ar57/wenyu/data/Amazon-Reviews-2023/raw/review_categories/Grocery_and_Gourmet_Food.jsonl"
    META_FILE = "/fs04/ar57/wenyu/data/Amazon-Reviews-2023/raw/meta_categories/meta_Grocery_and_Gourmet_Food.jsonl.gz"
    OUTPUT_DIR = "/fs04/ar57/wenyu/result/personal_query/00_data_preparation/Grocery_and_Gourmet_Food"
