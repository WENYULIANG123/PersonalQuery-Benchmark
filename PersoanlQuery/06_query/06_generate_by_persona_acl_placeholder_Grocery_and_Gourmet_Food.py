...
MAX_WORKERS = 10
BATCH_SIZE = 100
USER_PROFILES_FILE = '/home/wlia0047/ar57/wenyu/result/personal_query/05_syntactic_analysis/Grocery_and_Gourmet_Food/acl_user_profiles.json'
...
USER_ERROR_FILE = '/home/wlia0047/ar57/wenyu/result/personal_query/04_writing_analysis/Grocery_and_Gourmet_Food/acl_error.json'
OUTPUT_FILE = '/fs04/ar57/wenyu/result/personal_query/06_query/Grocery_and_Gourmet_Food/acl_query.json'
...
def call_llm(prompt: str) -> str:
    """调用LLM，遇到速率限制时自动重试"""
    client = ZAIAnthropicClient(model='glm-4.5-air')
    wait_seconds = 5
    max_retries = 20
