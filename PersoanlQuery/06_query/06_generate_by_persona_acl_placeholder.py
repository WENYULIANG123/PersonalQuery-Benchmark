...
# 硬编码参数
# ========================================
NUM_USERS_TO_TEST = 100       # 测试用：只处理前N个用户
MAX_WORKERS = 10
BATCH_SIZE = 100
...
USER_ERROR_FILE = '/home/wlia0047/ar57/wenyu/result/personal_query/04_writing_analysis/acl_error.json'
OUTPUT_FILE = '/fs04/ar57/wenyu/result/personal_query/06_query/acl_query.json'
