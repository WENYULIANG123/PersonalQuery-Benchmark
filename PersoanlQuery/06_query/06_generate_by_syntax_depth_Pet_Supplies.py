#!/usr/bin/env python3
"""
Generate Pet_Supplies queries controlled by user-level syntax tree depth.
...
BASE_SCRIPT = Path("/home/wlia0047/ar57/wenyu/PersoanlQuery/06_query/06_generate_by_persona_placeholder_Pet_Supplies.py")
if not BASE_SCRIPT.exists():
    raise FileNotFoundError(f"base script not found: {BASE_SCRIPT}")

_BASE_SPEC = importlib.util.spec_from_file_location("stage6_pet_base", BASE_SCRIPT)
