...
ACL_NOISY_QUERY_FILE = f"{GLOBAL_PATHS['inject_noisy']}/Arts_Crafts_and_Sewing/acl_noisy_query.json"
CCOMP_NOISY_QUERY_FILE = f"{GLOBAL_PATHS['inject_noisy']}/Arts_Crafts_and_Sewing/ccomp_noisy_query.json"
