...
def main():
    ...
    metadata_file = "/root/result/personal_query/08_retrieval/document_cache/Pet_Supplies_metadata_2023.pkl"
    ...
    if os.path.exists(metadata_file):
        ...
        raw_metadata_file = "/workspace/PersonalQuery/data/Amazon-Reviews-2023/raw/meta_categories/meta_Pet_Supplies.jsonl.gz"
    ...
    cache_dir = "/root/result/personal_query/08_retrieval/retriever_Pet_Supplies_cache"
