...
def load_colbertv2_build_module():
    module_path = retrieval_root / "08_build_retriever_indices_Pet_Supplies.py"
    if not module_path.exists():
        raise FileNotFoundError(f"Required ColBERTv2 build module not found: {module_path}")

    spec = importlib.util.spec_from_file_location("build_retriever_indices_pet_supplies", module_path)
