...
def main():
    ...
    OUTPUT_FILE = "/fs04/ar57/wenyu/result/personal_query/01_preference_extraction/Arts_Crafts_and_Sewing/attributes_Arts_Crafts_and_Sewing.json"
    STAGE0_DIR = "/fs04/ar57/wenyu/result/personal_query/00_data_preparation/Arts_Crafts_and_Sewing"
