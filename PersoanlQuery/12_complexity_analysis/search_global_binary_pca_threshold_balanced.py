#!/usr/bin/env python3
"""Search one shared PCA threshold with balance-first objective for two tiers."""
...
SUMMARY_FILE = OUTPUT_DIR / "global_binary_pca_threshold_balanced_search.json"
MIN_TIER_RATIO = 0.10
...
def search_best_threshold(rows: list[dict], retrievers: list[str]) -> dict:
    ...
    for split_idx in range(min_tier_size, n - min_tier_size + 1):
        ...
        imbalance = abs(low_count - high_count)
...
def main() -> None:
    ...
    summary = {
        ...
        "objective": "balance_first_then_total_abs_gap_then_min_abs_gap",
        "best_threshold": best,
    }
