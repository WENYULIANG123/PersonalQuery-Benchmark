#!/usr/bin/env python3
"""Unique entrypoint for Stage 12 on Baby_Products only."""
...
def main() -> None:
    ...
    summary = module.process_category(category, None)
    ...
    root_summary = {
        ...
        "categories": [category],
        "num_categories": 1,
        "num_feature_rows": int(summary["num_feature_rows"]),
        "summaries": {
            category: {
    ...
    module.log("=" * 80)
    module.log("Stage 12 Baby_Products 完成")
    module.log(f"  {category}: {summary['num_feature_rows']} 条特征记录")
