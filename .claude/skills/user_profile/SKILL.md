...
| 7 | 迭代式优化 | 双查询 + 风格特征 | 风格对齐查询 |
| 8 | 难度打分 | 查询词汇 | 拼写难度打分模型 |
| 9 | 噪声注入 | 对齐查询 + 难度模型 | 含靶向噪声查询 |
| 10 | 多维评估 | 所有输出 | 评估报告 |
...
- **07_iterative_refinement/07_iterative_refinement.py**: 迭代式优化主脚本
- **07_iterative_refinement/07_extract_sentence_level_features.py**: 句子级别特征提取
...
python3 /home/wlia0047/ar57/wenyu/.cursor/hooks/sbatch_wrapper.py \
    "source /apps/anaconda/2024.02-1/etc/profile.d/conda.sh && \
     conda activate /home/wlia0047/ar57_scratch/wenyu/stark && \
     python -u /home/wlia0047/ar57/wenyu/.claude/skills/user_profile/07_iterative_refinement/07_iterative_refinement.py \
     ...
     --output-dir /home/wlia0047/wenyu/result/user_profile/07_iterative_refinement \
     --max-rounds 5 \
...
- **08_spelling_difficulty/08_train_spelling_model.py**: 训练融合了字符字形特征、专家规则特征与多维度的虚拟用户错误权重的联合拼写难度判定模型
...
python3 /home/wlia0047/ar57/wenyu/.cursor/hooks/sbatch_wrapper.py --gpu \
    "source /apps/anaconda/2024.02-1/etc/profile.d/conda.sh && \
     conda activate /home/wlia0047/ar57_scratch/wenyu/stark && \
     python -u /home/wlia0047/ar57/wenyu/.claude/skills/user_profile/08_spelling_difficulty/08_train_spelling_model.py"
```
...
- **09_targeted_noisy_query/09_generate_noisy_queries.py**: 抽取双查询和用户写作风格画像进行打分并进行目标制导的高阶靶向错误注入。
...
python3 /home/wlia0047/ar57/wenyu/.cursor/hooks/sbatch_wrapper.py --gpu \
    "source /apps/anaconda/2024.02-1/etc/profile.d/conda.sh && \
     conda activate /home/wlia0047/ar57_scratch/wenyu/stark && \
     python -u /home/wlia0047/ar57/wenyu/.claude/skills/user_profile/09_targeted_noisy_query/09_generate_noisy_queries.py \
     --spelling-model-path /home/wlia0047/ar57/wenyu/.claude/skills/user_profile/08_spelling_difficulty/08_spelling_difficulty_scorer_v1.pt \
     --stage8-results /home/wlia0047/wenyu/result/user_profile/07_iterative_refinement/iterative_refinement_v2/iterative_results.json \
     --writing-analysis-dir /home/wlia0047/wenyu/result/user_profile/04_writing_analysis/results \
     --output-dir /home/wlia0047/wenyu/result/user_profile/09_targeted_noisy_query \
