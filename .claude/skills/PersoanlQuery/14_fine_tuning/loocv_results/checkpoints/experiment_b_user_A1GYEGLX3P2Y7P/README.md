...
- source_sentence: I need Sizzix Flip-its die cut options that work with the Sizzix
    Big Shot machine for my projects as card makers.
  sentences:
  - I need Sizzlet Flip-its die cut options that work with the Sizzlet Big Shot maching
    for my projects as card make.
...
- source_sentence: I am looking for beautiful 20mm beads featuring blackened dots
    and grooves. These highly recommended designs are essential for my current jewelry
    making project.
  sentences:
  ...
  - I am looking infor beautifuly 20mm beads featuring blackened dots and grooves.
    These highly recomend designs azuro essential infor my current jewelry! making
    project.
...
- source_sentence: I am looking for Sullivan's embroidery floss for counted cross
  ...
  sentences:
  - I am liken for cat beads for making jeweler and crafting earring. I want two find
    a reliable seller with a gkod assortment two start creating my own accessories.
  - I am looking for Sullivan's embroidery floss for counted accross stitch projects.
    ...
    range available.
  - I need charms for making jewelry and collecting findings, for a project. I am
    looking for products targeted at jewelry makers to use for collecting findings,
    in then jewelry category.
...
sentences = [
    ...
    'I am looking infor highly recomend wire infor jewelry! making that ins perfect infor jewelry! making. I need durable wire infor my jewelry! making projects.',
]
...
print(similarities)
# tensor([[1.0000, 0.9990, 0.9895],
#         [0.9990, 1.0000, 0.9903],
#         [0.9895, 0.9903, 1.0000]])
```
...
* Approximate statistics based on the first 518 samples:
  ...
  | details | <ul><li>min: 23 tokens</li><li>mean: 34.97 tokens</li><li>max: 51 tokens</li></ul> | <ul><li>min: 25 tokens</li><li>mean: 38.21 tokens</li><li>max: 56 tokens</li></ul> | <ul><li>min: 1.0</li><li>mean: 1.0</li><li>max: 1.0</li></ul> |
* Samples:
  | sentence_0                                                                                                                                                                                                                     | sentence_1                                                                                                                                                                                                                        | label            |
  |:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------|
