...
lftk_df = pd.read_csv(REPO_ROOT / 'lftk_ids.csv')
...
# Override name_map with more readable feature names for interaction analysis
name_map_override = {
'a_char_ps': 'Characters per Sentence',
'wordtokens': 'Word Count',
'a_word_ps': 'Words per Sentence',
't_char': 'Character Count',
'a_syll_ps': 'Syllables per Sentence',
't_sent': 'Sentence Count',
'a_char_pw': 'Characters per Word',
'C': 'Clause Count',
'a_n_ent_norp_ps': 'NORP Entities',
'T': 'T-unit Count',
'a_n_ent_gpe_ps': 'GPE Entities',
'a_noun_ps': 'Noun Count',
'a_n_ent_law_ps': 'Law Entities',
'a_num_ps': 'Numeral Count',
'a_n_ent_money_ps': 'Money Entities',
't_stopword': 'Stop Words',
'a_n_ent_ordinal_ps': 'Ordinal Entities',
'a_propn_ps': 'Proper Nouns',
'swordtypes': 'Sophisticated Words',
'CT': 'Complex T-units',
'swordtokens': 'Sophisticated Word Count',
'CN': 'Complex Nominals',
'slextypes': 'Sophisticated Lexical Words',
'CP': 'Dependent Clauses',
'ls2': 'Lexical Sophistication',
'vs1': 'Verb Sophistication',
'ttr': 'Unique Word Ratio',
'wordtokens': 'Total Words',
'vv1': 'Unique Verb Ratio',
'lextypes': 'Unique Lexical Words',
'a_cconj_ps': 'Coordinating Conjunctions',
'advv': 'Unique Adverb Ratio',
'a_sconj_ps': 'Subordinating Conjunctions',
'adjv': 'Unique Adjective Ratio',
't_bry': 'Age of Acquisition Score',
'auto': 'Readability Level',
'rt_average': 'Reading Time',
'VP': 'Verb Phrases',
}

# Update the name_map with the overrides
name_map.update(name_map_override)