...
def main():
    ...
    # 使用T5-v1.1-xl语义池化版本
    args.ckpt = "/fs04/ar57/wenyu/.claude/skills/PersoanlQuery/05_syntactic_analysis/checkpoints/0403_12-29-34-ling_conversion-decoder_add_first/checkpoint-1500"
    args.disc_ckpt = None
    args.sem_ckpt = None
    args.seed = 42
    ...
    print(f"use_semantic_pooling = {model.use_semantic_pooling}")
    print("模型加载完成\n")
