...
from utils.retrievers import TFIDFRetriever
...
def main():
    parser = argparse.ArgumentParser(description="TF-IDF Retrieval Evaluation")
    ...
    output_file = os.path.join(OUTPUT_DIR, f"retrieval_tfidf_{QUERY_MODE}_{USER_ID}.json")
