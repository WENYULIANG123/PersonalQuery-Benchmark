...
def build_retriever(retriever_name: str, documents: List[Dict], doc_hash: str, cache_dir: str) -> Tuple[bool, str]:
...
def main():
    ...
    for retriever_name in ALL_RETRIEVERS:
        ...
        if cache_exists(retriever_name, doc_hash, cache_dir):
            ...
            try:
                success, cache_path = build_retriever(retriever_name, documents, doc_hash, cache_dir)
