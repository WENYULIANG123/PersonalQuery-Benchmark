...
def main():
    parser = argparse.ArgumentParser(description="E5 Retrieval Evaluation")
    ...
    e5_candidates_file = os.path.join(OUTPUT_DIR, f"e5_candidates_{QUERY_MODE}_{USER_ID}_target.json")
    ...
    output_file = os.path.join(OUTPUT_DIR, f"retrieval_e5_{QUERY_MODE}_{USER_ID}.json")
    ...
    log_with_timestamp(f"\nTarget User Queries (E5-large-v2, {QUERY_MODE} mode):")
