...
def main():
    parser = argparse.ArgumentParser(description="BGE Retrieval Evaluation")
    ...
    output_file = os.path.join(OUTPUT_DIR, f"retrieval_bge_{QUERY_MODE}_{USER_ID}.json")
    ...
    log_with_timestamp(f"\nTarget User Queries (BGE-large-en, {QUERY_MODE} mode):")
