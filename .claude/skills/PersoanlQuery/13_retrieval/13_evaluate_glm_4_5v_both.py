#!/usr/bin/env python3
"""GLM-4.5V Reranker Evaluation (Standard + Personalized) - Using cached BM25 candidates"""
...
def main():
    ...
    glm_per = PersonalizedGLMReRanker(first_stage_per, top_k=TOP_K_CANDIDATES, persona_dir=PERSONA_DIR, model=GLM_MODEL)
